...
4. Inspect the top 5–10 result apps using iTunes API plus direct App Store URLs; use Google/Bing/DuckDuckGo or an agent browser when useful, falling back immediately on CAPTCHA/bot blocks. Compare product job, positioning, genre, descriptions, screenshots/product pages, and optional Sensor Tower public evidence.
